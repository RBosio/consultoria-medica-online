      ...
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col items-center mb-2 mt-2">
          ...
          <div className="flex items-center">
            ...
            <p className="px-2">{props.doctor.user.healthInsurances.map((hi: any) => {
              return (
                <p className="flex items-center gap-2">{hi.healthInsurance.name} {hi.verified ? <FaCircleCheck className="text-green-600 text-xl"/> : <FaCircleXmark className="text-red-600 text-xl" />}</p>
              )
              })}</p>
          </div>
