...
import { Chip, Divider, MenuItem, useTheme } from "@mui/material";
    ...
    <Layout auth={props.auth}>
      <section>
        ...
        <div className="flex justify-between items-center gap-4 w-5/6 mx-auto mt-4">
          <div className="bg-white w-2/3 p-4 rounded-3xl shadow-lg">
...
export const getServerSideProps = withAuth(
  async (auth: Auth | null, context: any) => {
    let lastMeeting = await axios.get(
      `${process.env.NEXT_PUBLIC_API_URL}/meeting/lastMeeting/${auth?.id}`,
      {
        withCredentials: true,
